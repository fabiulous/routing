...
export namespace Routing {
  ...
  export type ConfigFn = (path: string, params: Maybe<Routing.RouteParams>, replace?: boolean) => void;
  ...
  export type RecursiveRoutes<T extends Config | Record<string, Routes>> = {
